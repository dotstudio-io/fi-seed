...
app.set('views', path.join(__dirname, configs.views.basedir));
...
app.use(favicon(configs.static.basedir + '/icons/favicon.png')); /* Serve favicon */
...
/**** Initialization *****/
configs.database(function (err) { /* Connect to the database */
